            ...
            for icol in cols[i.value]:
                for jcol in cols[j.value]:
                    for kcol in cols[k.value]:
                        ...
                        allTrue = Cardinality.conditional({
                                i.value : icol,
                                j.value : jcol,
                                k.value : kcol
                        ...
                        if (allTrue > 1):
                            ...
                            # # 111
                            # if(allTrue/Cardinality.conditional({                            
                            #     k.value : kcol
